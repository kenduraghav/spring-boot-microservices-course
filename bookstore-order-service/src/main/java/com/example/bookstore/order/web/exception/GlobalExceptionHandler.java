...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private static final URI INTL_SERVER_ERROR_TYPE = URI
			.create("https://api.bookstore.com/errors/internal-server-error");
	...
	ProblemDetail handleUnhandledException(Exception ex) {
		...
		ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(INTERNAL_SERVER_ERROR, "Something went wrong. Please try again later.");
